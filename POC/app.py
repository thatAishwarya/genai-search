...
from POC.document_handler2 import read_documents_from_directory, extract_text
from query_handler2 import QueryHandler
...
class Testoid():
    ...
    def idx_init(self, index_path):
        ...
        if os.path.exists(index_path):
            ...
            self.embedding_handler = EmbeddingHandler2()
